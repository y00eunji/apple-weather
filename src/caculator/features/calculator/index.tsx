import { HistoryContext } from '@/caculator/app/context/historyContext.tsx';
import { actions } from '@/caculator/features/calculator/utils/actions.ts';
import { OPERATORS, OperatorsType } from '@/caculator/shared/constant/operators.ts';
import Button from '@/caculator/shared/ui/button';
...
interface ButtonsProps {
  setInput: (_value: ((_prevState: string) => string) | string) => void;
  inputValue: string;
}
